...
//name here is equal to getFullName
let user=(name)=>console.log(`Hello, my full name is ${name}.`)
...
//and my user function=callback
greeting('Laman','Ismayilova',user)
////////// PROBLEM 4 //////////
...
// CODE HERE
let pricesPlusTax = (prices,callback)=>{
    prices.forEach((price)=>{
        var newPrice =price+price*0.2
        totalCost.push(newPrice)
    })
    callback(totalCost) 
}
//prices here is price from forEach
let dispLayTotalCost=(prices)=>console.log(`Total cost is: ${prices}`)
...
// CODE HERE
pricesPlusTax(prices,dispLayTotalCost)
...
// CODE HERE
let multiplyingFactory =(parameter)=>(paramater2)=>{
                 if(parameter>=5){
                    console.log(`The answer is : ${parameter*paramater2}`)
                 }else{
...
// CODE HERE
let timesFour=multiplyingFactory(6)
timesFour(3)
...
// INVOKE 'timesFour' HERE
 timesFour=multiplyingFactory(4)
timesFour(3)
